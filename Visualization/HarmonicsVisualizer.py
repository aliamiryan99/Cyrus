...
class HarmonicVisualizer:
    ...
    def __init__(self, symbol, time_frame, data, extremum_window, time_range, price_range_alpha, harmonic_name):
        ...
        self.bullish_result = harmonic_pattern(self.open, self.high, self.low, self.close, self.top, self.bottom, self.middle, self.local_min_price_area, self.local_max_price_area, self.symbol, self.time_frame, self.harmonic_name, "Bullish", True)
        self.bearish_result = harmonic_pattern(self.open, self.high, self.low, self.close, self.top, self.bottom, self.middle, self.local_min_price_area, self.local_max_price_area, self.symbol, self.time_frame, self.harmonic_name, "Bearish", True)

        self.bullish_result = filter_results(self.high, self.low, self.bullish_result, self.middle, self.harmonic_name, "Bullish")
        self.bearish_result = filter_results(self.high, self.low, self.bearish_result, self.middle, self.harmonic_name, "Bearish")
