...
class ChannelsVisualizer:
    ...
    def draw(self, fig, height, parameters):
            ...
            for up_channel in self.up_channels:
                ...
                fig.line(x, y, color='blue', widht=1)
                ...
                fig.line(x, y, color='blue', widht=1, line_dash="dotted")
            ...
            for down_channel in self.down_channels:
                ...
                fig.line(x, y, color='red', widht=1)
                ...
                fig.line(x, y, color='red', widht=1, line_dash="dotted")
