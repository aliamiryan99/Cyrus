...
class LauncherConfig:
    ...
    def __init__(self, symbol, data, start_i, balance_ratio):
        ...
        #self.algorithm = DivergenceAlgorithm(symbol, data[start_i - self.history_size:start_i], self.big_window, self.small_window, self.hidden_divergence_check_window, self.upper_line_tr, self.divergence_alpha)
        ...
        #self.trailing_tool = TrailingWithHugeCandle(data[start_i - self.history_size:start_i], self.trailing_huge_alpha, self.trailing_huge_beta, self.trailing_huge_mode, self.trailing_huge_extremum_window, self.trailing_huge_extremum_pivot)
