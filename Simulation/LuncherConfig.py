...
class LauncherConfig:
    ...
    def __init__(self, symbol, data, start_i, balance_ratio):
        ...
        self.me_extremum_window = 4
        self.me_extremum_mode = 1  # 1 : High Low , 2 : Top Bottom
        self.me_extremum_level = 4
        self.me_extremum_pivot = 1
        self.me_mode = 1     # monotone_mode ; 1 : limit price is taken from last extremum price , 2 : limit price is taken from last candle
        ...
        # Strong Simple Idea Algorithm
        self.ssi_win_inc = 3
        self.ssi_win_dec = 3
        self.ssi_shadow_threshold = 10
        self.ssi_body_threshold = 0
        self.ssi_mode = 1  # 1 : standard , 2 : with average condition
        self.ssi_mean_window = 20
        self.ssi_extremum_window = 1
        self.ssi_extremum_mode = 2
        self.ssi_huge_detection_window = 5
        self.ssi_alpha = 0.5
        ...
        #self.algorithm = HighLowBreakAlgorithm(symbol, data[start_i - self.history_size:start_i], self.high_low_break_window, self.high_low_break_pivot)
