...
class LauncherConfig:
    ...
    def __init__(self, symbol, data, start_i, balance_ratio):
        ...
        # Recovery Section
        self.recovery_algorithm = Recovery(symbol, data, self.recovery_window_size, self.recovery_alpha)
