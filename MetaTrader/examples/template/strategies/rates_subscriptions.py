...
"""
    ...
    from EURUSD at M1 and GBPUSD at M5.
    
    After receiving 5 rates from EURUSD_M1 it cancels its feed 
    and waits 3 rates from GPBUSD. At this point it cancels all rate feeds. Then it prints
    ...
    For example, to receive rates from instruments EURUSD(M1) and GBPUSD(M5), this client
    will send this command to the Server, through its PUSH channel:

    "TRACK_RATES;EURUSD;1;GBPUSD;5"
    ...
    "GBPUSD_M5 TIME;OPEN;HIGH;LOW;CLOSE;TICKVOL;SPREAD;REALVOL"
...
class rates_subscriptions(DWX_ZMQ_Strategy):
    ...
    def __init__(self, 
                 ...
                 _instruments=[('EURUSD.I_M1', 'EURUSD.I', 1)],
                 _delay=0.1,
                 _broker_gmt=3,
                 _verbose=False):
    ...
    def onSubData(self, data):        
        ...
        # increment counters
        if _topic == self._instruments[0][0]:
          self._eurusd_cnt += 1
...
if __name__ == "__main__":
  ...
  # creates object with a predefined configuration: intrument list including EURUSD_M1 and GBPUSD_M5
