...
class rates_historic(DWX_ZMQ_Strategy):
    ...
    def run(self):        
        ...
        # request rates
        print('Requesting Minute Rates from EURUSD')
        self._zmq._DWX_MTX_SEND_HIST_REQUEST_(_symbol='EURUSD.I',
                                              _timeframe=1440,
                                              _count=20)
        sleep(0.1)
        print('\nHistory Input Dictionary:')
        print(self._zmq._History_DB['EURUSD.I_D1'])
