...
void Draw(string& compArray[], string& zmq_ret){
   ...
   */
   ...
   switch(switch_action) {
         ...
         case 2: //HLINE
            // Foramt : ChartId | Name | SubWindow | Price | Color | Style | Width | Back | Selection | Hidden | ZOrder
            // Function definition:
         ...
         case 3: //TREND
            // Foramt : ChartId | Name | SubWindow | Time1 | Price1 | Time2 | Price2 | Color | Style | Width | Back | Selection | Ray | Hidden | ZOrder
            // Function definition:
            cnt = SplitMessage(compArray[3], names, ",");
         ...
         case 4: //RECTANGLE
            // Foramt : ChartId | Name | SubWindow | Time1 | Price1 | Time2 | Price2 | Color | Style | Width | Fill | Back | Selection | Hidden | ZOrder
            // Function definition:
            cnt = SplitMessage(compArray[3], names, ",");
            SplitMessage(compArray[5], times1, ",");
            SplitMessage(compArray[6], prices1, ",");
         ...
         case 5: //TRIANGLE
            // Foramt : ChartId | Name | SubWindow | Time1 | Price1 | Time2 | Price2 | Time3 | Price3 | Color | Style | Width | Fill | Back | Selection | Hidden | ZOrder
            // Function definition:
            cnt = SplitMessage(compArray[3], names, ",");
            SplitMessage(compArray[5], times1, ",");
            SplitMessage(compArray[6], prices1, ",");
         ...
         case 6: //ELLIPSE
            // Foramt : ChartId | Name | SubWindow | Time1 | Price1 | Time2 | Price2 | Scale | Color | Style | Width | Fill | Back | Selection | Hidden | ZOrder
            // Function definition:
            cnt = SplitMessage(compArray[3], names, ",");
            SplitMessage(compArray[5], times1, ",");
            SplitMessage(compArray[6], prices1, ",");
         ...
         case 7: //THUMBUP
            // Foramt : ChartId | Name | SubWindow | Time1 | Price1 | Anchor | Color | Style | Width | Back | Selection | Hidden | ZOrder
            // Function definition:
            cnt = SplitMessage(compArray[3], names, ",");
            SplitMessage(compArray[5], times1, ",");
            SplitMessage(compArray[6], prices1, ",");
         ...
         case 11: //ARROWBUY
            // Foramt : ChartId | Name | SubWindow | Time1 | Price1 | Color | Style | Width | Back | Selection | Hidden | ZOrder
            // Function definition:
            cnt = SplitMessage(compArray[3], names, ",");
            SplitMessage(compArray[5], times1, ",");
            SplitMessage(compArray[6], prices1, ",");
         ...
         case 13: //TEXT
            // Foramt : ChartId | Name | SubWindow | Time | Price | Text | Font | FontSize | Color | Angle | Anchor | Back | Selection | Hidden | ZOrder
            // Function definition:
            cnt = SplitMessage(compArray[3], names, ",");
            SplitMessage(compArray[5], times1, ",");
            SplitMessage(compArray[6], prices1, ",");
         ...
         case 14: //LABEL
            // Foramt : ChartId | Name | SubWindow | X | Y | Corner | Text | Font | FontSize | Color | Angle | Anchor | Back | Selection | Hidden | ZOrder
            // Function definition:
            cnt = SplitMessage(compArray[3], names, ",");
         ...
         case 15: //RectLabel
            // Foramt : ChartId | Name | SubWindow | X | Y | Width | Height | BackColor | Border | Corner | Color | Style | LineWidth | Back | Selection | Hidden | ZOrder
            // Function definition:
            cnt = SplitMessage(compArray[3], names, ",");
            SplitMessage(compArray[5], x1, ",");
            SplitMessage(compArray[6], y1, ",");
