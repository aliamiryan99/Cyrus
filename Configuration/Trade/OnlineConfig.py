...
class Config:
    ...
    spreads = {'EURUSD': 20, 'GBPUSD': 30, 'NZDUSD': 40, 'USDCAD': 40, 'USDCHF': 30, 'USDJPY': 30,
               ...
               'BTCUSD': 5000, 'ETHUSD': 1000, 'LTCUSD': 1000, 'DOGEUSD': 100, 'US30.MAR2': 60,
    ...
    symbols_dict = {'EURUSD.I': 0, 'GBPUSD.I': 1, 'NZDUSD.I': 2, 'USDCAD.I': 3, 'USDCHF.I': 4, 'USDJPY.I': 5,
                    ...
                    'BTCUSD': 26, 'ETHUSD': 27, 'LTCUSD': 28, 'DOGEUSD': 29, 'US30.MAR2': 84,
    ...
    symbols_list = ['EURUSD.I', 'GBPUSD.I', 'NZDUSD.I', 'USDCAD.I', 'USDCHF.I', 'USDJPY.I', 'AUDUSD.I',
                    ...
                    'USDRUB', 'USDZAR', 'US30.MAR2',
                    'AUDCAD.I', 'AUDCHF.I', 'AUDJPY.I', 'AUDNZD.I', 'CADCHF.I',
    ...
    symbols_pip = {'EURUSD.I': 5, 'GBPUSD.I': 5, 'NZDUSD.I': 5, 'USDCAD.I': 5, 'USDCHF.I': 5,
                   ...
                   'USDJPY': 2, 'AUDUSD': 4, 'GOLD': 1, 'SILVER': 2, 'US30.MAY1': 1, 'US30.DEC1': 1, 'US30.MAR2': 0,
                   ...
                   'USDRUB': 4, 'USDZAR': 5,
                   'AUDCAD.I': 5, 'AUDCHF.I': 5, 'AUDJPY.I': 3, 'AUDNZD.I': 5, 'CADCHF.I': 5,
    ...
    symbols_pip_value = {'EURUSD.I': 10 ** 5, 'GBPUSD.I': 10 ** 5, 'NZDUSD.I': 10 ** 5, 'USDCAD.I': 10 ** 5,
                         ...
                         'USDZAR': 10 ** 5,
                         'AUDCHF.I': 10 ** 5, 'AUDJPY.I': 10 ** 3, 'AUDNZD.I': 10 ** 5, 'CADCHF.I': 10 ** 5,
    ...
    symbols_with_usd = {'EURUSD.I': True, 'GBPUSD.I': True, 'NZDUSD.I': True, 'USDCAD.I': False, 'USDCHF.I': False,
                        ...
                        'SILVER': True, 'US30.MAY1': True, 'US30.DEC1': True, 'US30.MAR2': True,
                        ...
                        'USDZAR': True,
                        'AUDCHF.I': True, 'AUDJPY.I': True, 'AUDNZD.I': True, 'CADCHF.I': True,
